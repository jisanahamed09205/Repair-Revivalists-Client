...
const Details = () => {
    ...
    const handlePurchase = e =>{
        ...
        fetch('https://repair-revivalists-server.vercel.app/bookings',{
            method: 'POST',
            headers:{
    ...
    return (
        <div>
            ...
            <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 dark:bg-gray-800 dark:text-gray-50">
                ...
                <h2 className="my-5 text-center text-2xl font-bold">Provider Info</h2>
                    <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        <img src={service_provider_img} alt="" className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-700" />
                        <div className="flex flex-col">
                            <h4 className="text-xl font-semibold">Provider Name: {service_provider_name}</h4>
                            <p className="dark:text-gray-400">Service Area: {service_area}</p>
                            <h6 className=" text-center text-lg font-medium underline">About</h6>
                            <p className="dark:text-gray-400">TechFix Solutions is a dedicated team of skilled technicians passionate about repairing and restoring electronic devices. With over a decade of experience, we specialize in providing high-quality repair services for a wide range of gadgets, including smartphones, laptops, tablets, gaming consoles, and more.</p>
                        </div>
                    </div>
